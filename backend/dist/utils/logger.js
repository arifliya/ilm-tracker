...
const level = env_1.env.NODE_ENV === "test" ? "silent" : env_1.env.NODE_ENV === "production" ? "info" : "debug";
exports.logger = (0, pino_1.default)({
    level,
    transport: env_1.env.NODE_ENV === "development" ? { target: "pino-pretty", options: { colorize: true } } : undefined
});
